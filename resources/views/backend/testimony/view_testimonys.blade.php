            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered dataTable" id="table-1">
               ...
               @foreach($records as $item) 
                ...
                <td>
                  <a href="{{ url($item->id . '/view_testimony')}}" ><button  class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>                    
                  <a href="{{ url($item->id . '/edit_testimony') }}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                  <a href="{{ url($item->id . '/delete_testimony') }}" id="click" title="delete Student"><button class="btn btn-danger btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Move to trash</button></a>
